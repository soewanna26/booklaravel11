                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        <a href="{{ route('home.detail', $book->id) }}">
                            @if ($book->image != '')
                                <img src="{{ asset('uploads/book/thumb/' . $book->image) }}" alt=""
                                    class="card-img-top">
                            @else
                                <img src="https://placehold.co/1280x720?text=No Image" alt="" class="card-img-top">
                            @endif
                        </a>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="row mt-4">
                            ...
                            @if ($realatedBooks->isNotEmpty())
                                @foreach ($realatedBooks as $realatedBook)
                                    <div class="col-md-4 col-lg-4 mb-4">
                                        <div class="card border-0 shadow-lg">
                                            <a href="{{ route('home.detail', $realatedBook->id) }}">
                                                @if ($realatedBook->image != '')
                                                    <img src="{{ asset('uploads/book/thumb/' . $realatedBook->image) }}"
                                                        alt="" class="card-img-top">
                                                @else
                                                    <img src="https://placehold.co/1280x720?text=No Image" alt=""
                                                        class="card-img-top">
                                                @endif
                                            </a>
                                            <div class="card-body">
                                                <h3 class="h4 heading"><a
                                                        href="{{ route('home.detail', $realatedBook->id) }}">{{ $realatedBook->title }}</a>
                                                </h3>
                                                <p>by {{ $realatedBook->author }}</p>
                                                <div class="star-rating d-inline-flex ml-2" title="">
